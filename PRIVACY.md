...
This is an undocumented OpenAI backend endpoint. It can change or stop working without notice. Disable the feature by removing `OPENCODE_HUD_CODEX_USAGE=1` and restarting OpenCode.
